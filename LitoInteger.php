...
<head>
    ...
    <title>Testing LitoMyInteger Class</title>
</head>
<body>
    <h1>Testing LitoMyInteger Class</h1>
    ...
    $integer1 = new LitoMyInteger(17);
    $integer2 = new LitoMyInteger(24);
